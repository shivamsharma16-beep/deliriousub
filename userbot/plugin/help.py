...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query.startswith("Userbot"):
            ...
            result = builder.article(
                ...
                "© Delirious UserBot Help",

                text="{}\nCurrently Loaded Plugins: UNAVAILABLE".format(
...
else : "Maa Bahin Chudao Apana Userbot Kahe Nahi Banate Pappu Bhaiya.\n  Join Delirious UserBot for learning how to get userbot!"
    ...
    async def on_plug_in_callback_query_handler(event):
        ...
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = "Get your own Delirious UserBot , don't use others's\n Join  for learning how to get userbot!"
